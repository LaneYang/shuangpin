...
var keyboard_layouts = {
  ...
  qgmlwy: {
    'q': [0, 0], 'g': [1, 0], 'm': [2, 0], 'l': [3, 0], 'w': [4, 0],
    'y': [5, 0], 'f': [6, 0], 'u': [7, 0], 'b': [8, 0], ';': [9, 0],
    'd': [0, 1], 's': [1, 1], 't': [2, 1], 'n': [3, 1], 'r': [4, 1],
    'i': [5, 1], 'a': [6, 1], 'e': [7, 1], 'o': [8, 1], 'h': [9, 1],
    'z': [0, 2], 'x': [1, 2], 'c': [2, 2], 'v': [3, 2], 'j': [4, 2],
    'k': [5, 2], 'p': [6, 2], ',': [7, 2], '.': [8, 2], '/': [9, 2],
  },
  dvorak: {
  ...
  colemakdh: {
    'q': [0, 0], 'w': [1, 0], 'f': [2, 0], 'p': [3, 0], 'b': [4, 0],
    'j': [5, 0], 'l': [6, 0], 'u': [7, 0], 'y': [8, 0], ';': [9, 0],
    'a': [0, 1], 'r': [1, 1], 's': [2, 1], 't': [3, 1], 'g': [4, 1],
    'm': [5, 1], 'n': [6, 1], 'e': [7, 1], 'i': [8, 1], 'o': [9, 1],
    'z': [0, 2], 'x': [1, 2], 'c': [2, 2], 'd': [3, 2], 'v': [4, 2],
    'k': [5, 2], 'h': [6, 2], ',': [7, 2], '.': [8, 2], '/': [9, 2],
  },
  workman: {
  ...
  halmak: {
    'w': [0, 0], 'l': [1, 0], 'r': [2, 0], 'b': [3, 0], 'z': [4, 0],
    ';': [5, 0], 'q': [6, 0], 'u': [7, 0], 'd': [8, 0], 'j': [9, 0],
    's': [0, 1], 'h': [1, 1], 'n': [2, 1], 't': [3, 1], ',': [4, 1],
    '.': [5, 1], 'a': [6, 1], 'e': [7, 1], 'o': [8, 1], 'i': [9, 1],
    'f': [0, 2], 'm': [1, 2], 'v': [2, 2], 'c': [3, 2], '/': [4, 2],
    'g': [5, 2], 'p': [6, 2], 'x': [7, 2], 'k': [8, 2], 'y': [9, 2],
  },
  minimak: {
    'q': [0, 0], 'w': [1, 0], 'd': [2, 0], 'f': [3, 0], 'k': [4, 0],
    'y': [5, 0], 'u': [6, 0], 'i': [7, 0], 'l': [8, 0], ';': [9, 0],
    'a': [0, 1], 's': [1, 1], 't': [2, 1], 'r': [3, 1], 'g': [4, 1],
    'h': [5, 1], 'n': [6, 1], 'e': [7, 1], 'o': [8, 1], 'p': [9, 1],
    'z': [0, 2], 'x': [1, 2], 'c': [2, 2], 'v': [3, 2], 'b': [4, 2],
    'j': [5, 2], 'm': [6, 2], ',': [7, 2], '.': [8, 2], '/': [9, 2],
  },
  norman: {
    'q': [0, 0], 'w': [1, 0], 'd': [2, 0], 'f': [3, 0], 'k': [4, 0],
  ...
  asset: {
    'q': [0, 0], 'w': [1, 0], 'j': [2, 0], 'f': [3, 0], 'g': [4, 0],
    'y': [5, 0], 'p': [6, 0], 'u': [7, 0], 'l': [8, 0], ';': [9, 0],
    'a': [0, 1], 's': [1, 1], 'e': [2, 1], 't': [3, 1], 'd': [4, 1],
    'h': [5, 1], 'n': [6, 1], 'i': [7, 1], 'o': [8, 1], 'r': [9, 1],
    'z': [0, 2], 'x': [1, 2], 'c': [2, 2], 'v': [3, 2], 'b': [4, 2],
    'k': [5, 2], 'm': [6, 2], ',': [7, 2], '.': [8, 2], '/': [9, 2],
  },
  qwpr: {
    'q': [0, 0], 'w': [1, 0], 'p': [2, 0], 'r': [3, 0], 'f': [4, 0],
    'y': [5, 0], 'u': [6, 0], 'k': [7, 0], 'l': [8, 0], ';': [9, 0],
    'a': [0, 1], 's': [1, 1], 'd': [2, 1], 't': [3, 1], 'g': [4, 1],
    'h': [5, 1], 'n': [6, 1], 'i': [7, 1], 'o': [8, 1], 'e': [9, 1],
    'z': [0, 2], 'x': [1, 2], 'c': [2, 2], 'v': [3, 2], 'b': [4, 2],
    'j': [5, 2], 'm': [6, 2], ',': [7, 2], '.': [8, 2], '/': [9, 2],
  },
  toea: {
    ',': [0, 0], 'g': [1, 0], 's': [2, 0], 'z': [3, 0], 'b': [4, 0],
    'p': [5, 0], 'f': [6, 0], 'r': [7, 0], 'd': [8, 0], '.': [9, 0],
    't': [0, 1], 'o': [1, 1], 'a': [2, 1], 'e': [3, 1], 'y': [4, 1],
    'l': [5, 1], 'n': [6, 1], 'i': [7, 1], 'h': [8, 1], 'u': [9, 1],
    'x': [0, 2], 'q': [1, 2], 'j': [2, 2], 'c': [3, 2], 'v': [4, 2],
    'k': [5, 2], 'm': [6, 2], 'w': [7, 2], ';': [8, 2], '/': [9, 2],
  },
  chin: {
    ',': [0, 0], 't': [1, 0], 's': [2, 0], 'z': [3, 0], 'b': [4, 0],
    'p': [5, 0], 'f': [6, 0], 'r': [7, 0], 'd': [8, 0], '.': [9, 0],
    'o': [0, 1], 'e': [1, 1], 'a': [2, 1], 'g': [3, 1], 'y': [4, 1],
    'l': [5, 1], 'n': [6, 1], 'i': [7, 1], 'h': [8, 1], 'u': [9, 1],
    'x': [0, 2], 'q': [1, 2], 'j': [2, 2], 'c': [3, 2], 'v': [4, 2],
    'k': [5, 2], 'm': [6, 2], 'w': [7, 2], ';': [8, 2], "'": [9, 2],
  },
  graphite: {
    'b': [0, 0], 'l': [1, 0], 'd': [2, 0], 'w': [3, 0], 'z': [4, 0],
    "'": [5, 0], 'f': [6, 0], 'o': [7, 0], 'u': [8, 0], 'j': [9, 0],
    'n': [0, 1], 'r': [1, 1], 't': [2, 1], 's': [3, 1], 'g': [4, 1],
    'y': [5, 1], 'h': [6, 1], 'a': [7, 1], 'e': [8, 1], 'i': [9, 1],
    'q': [0, 2], 'x': [1, 2], 'm': [2, 2], 'c': [3, 2], 'v': [4, 2],
    'k': [5, 2], 'p': [6, 2], '.': [7, 2], '-': [8, 2], '/': [9, 2],
  },
  gallium2: {
    'b': [0, 0], 'l': [1, 0], 'd': [2, 0], 'c': [3, 0], 'v': [4, 0],
    'j': [5, 0], 'f': [6, 0], 'o': [7, 0], 'u': [8, 0], ',': [9, 0],
    'n': [0, 1], 'r': [1, 1], 't': [2, 1], 's': [3, 1], 'g': [4, 1],
    'y': [5, 1], 'h': [6, 1], 'a': [7, 1], 'e': [8, 1], 'i': [9, 1],
    'x': [0, 2], 'q': [1, 2], 'm': [2, 2], 'w': [3, 2], 'z': [4, 2],
    'k': [5, 2], 'p': [6, 2], "'": [7, 2], ';': [8, 2], '.': [9, 2],
  },
  hd: {
    'w': [0, 0], 'f': [1, 0], 'm': [2, 0], 'p': [3, 0], 'v': [4, 0],
    '/': [5, 0], '.': [6, 0], 'q': [7, 0], '"': [8, 0], "'": [9, 0],
    'r': [0, 1], 's': [1, 1], 'n': [2, 1], 't': [3, 1], 'b': [4, 1],
    ',': [5, 1], 'a': [6, 1], 'e': [7, 1], 'i': [8, 1], 'h': [9, 1],
    'x': [0, 2], 'c': [1, 2], 'l': [2, 2], 'd': [3, 2], 'g': [4, 2],
    '-': [5, 2], 'u': [6, 2], 'o': [7, 2], 'y': [8, 2], 'k': [9, 2],
  }
